...
//
//     final randomModal = randomModalFromJson(jsonString);

import 'dart:convert';

RandomModal randomModalFromJson(String str) => RandomModal.fromJson(json.decode(str));

String randomModalToJson(RandomModal data) => json.encode(data.toJson());
...
class RandomModal {
  ...
  factory RandomModal.fromJson(Map<String, dynamic> json) => RandomModal(
